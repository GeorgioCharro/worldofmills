...
function Header() {
    ...
    const searchRef = useRef(null); // Reference to the search input area
                ...
                <div className='flex items-center' ref={searchRef}>
                    ...
                    {searchOpen && (
                        <div className="relative">
                            ...
                            />
                            {results.length > 0 && (
                                <div className="absolute w-auto max-w-md left-0 p-2 bg-white shadow-lg overflow-auto z-10" style={{ maxHeight: '300px' }}>
                                    {results.map(machine => (
