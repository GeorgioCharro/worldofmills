...
function SearchResult({machine}) {
  return (
    <div className="flex justify-between items-center mb-4 relative">
      
      <div className="card card-side bg-base-100 shadow-xl pl-4 w-full">
        <figure><img className="w-full h-24 object-cover rounded-lg" src={machine.imgUrls[0]} alt="Machine"/></figure>
          <div className="card-body flex flex-col justify-center">
           <h3 className="card-title mb-0">{machine.machineName}</h3>
